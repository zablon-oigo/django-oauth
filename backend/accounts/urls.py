...
from .views import RegisterUserView,VerifyUserEmail,LoginUser,PasswordResetConfirm,SetNewPassword,PasswordResetRequestView,LogoutUserView,GoogleSignInView
